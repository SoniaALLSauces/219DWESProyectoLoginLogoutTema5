                 ...
                 */
                    ...
                    /* FORMULARIO */
                         ...
                         * y VALIDACIÓN con la base de datos de que usuario y contraseña es correcta */
                            if (isset($_REQUEST['login'])){  //Pulso el boton enviar
                                            ...
                                            <td>
                                                <div class="error"><?php
                                                        if ($aErrores['usuario']!=NULL || $aErrores['password']!=NULL) { //si hay errores muestra el mensaje
                                                            echo "<span style=\"color:red;\">Introduzca usuario y password correctos</span>"; //aparece el mensaje de error que tiene el array aErrores
                                                        }
                                                     ?></div>
                                            </td>
                                        </tr>
